...
Run the following to generate a dataset with 64 samples (32 training, 16 validation, 16 test):
    python submission/data/data_generation.py --train 2 --val 1 --test 1
...
4. Save the model to: /model/checkpoint/TIMESTAMP-model/
